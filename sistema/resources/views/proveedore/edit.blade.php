    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <select class="form-select" name="documento_id" id="documento_id">
                ...
                @if ($proveedore->persona->id ==$item->id)
        ...
        <div class="col-md-6">
            ...
            <input class="form-control" name="numero_documento" id="numero_documento" value="{{old('numero_documento',$proveedore->persona->numero_documento)}}">
